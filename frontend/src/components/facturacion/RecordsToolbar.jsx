...
export default function RecordsToolbar({ count, searchQuery, onSearchQueryChange, filterEstado, onFilterEstadoChange, filterOptions, onCreate, createLabel, createButtonLabel, onToggleFilters, filtersActive }) {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
